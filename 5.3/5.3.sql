...
INSERT INTO Products1 (ProductName, Stock) VALUES 
('Laptop', 50), 
('Smartphone', 30), 
('Tablet', 20);
...
begin
	...
	select ProductID from Products1;
...
exec dbo.DecreaseProductStock 2
...
create procedure NeverPlacedOrderInCustomer
as
begin
	declare @CustomerId int;
	declare neverp_cursor cursor for
	select CustomerID from Customers;
	
	open neverp_cursor;
	fetch next from neverp_cursor into @CustomerId;
